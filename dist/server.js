...
const Footer = () => {
    return React.createElement("footer", { className: rootClass },
        React.createElement("div", { className: `${rootClass}__container container` },
            ...
            React.createElement("p", { className: `${rootClass}__address` }, "1024, 1st Building, No. 68, Wanbo 4th Road, Nancun Town, Panyu Dc., Guangzhou city, China")),
        React.createElement("div", { className: `${rootClass}__smoke ${rootClass}__smoke--left` }),
        React.createElement("div", { className: `${rootClass}__smoke ${rootClass}__smoke--right` }),
